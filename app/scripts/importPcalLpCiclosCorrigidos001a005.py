# -*- coding: utf-8 -*-
"""Import ciclos corrigidos 001–005 (100 Q) — Língua Portuguesa, append-only."""
import json
import hashlib
import re
import unicodedata
...
SRC = Path(r"C:\Users\wwwmi\Downloads\ciclos_corrigidos_001_a_005_pc_al_100_questoes.json")
...
OUT_READY = PHASE6 / "app" / "imports" / "questions" / "pcal-lp-ciclos-corrigidos-001-a-005-ready.json"
OUT_REPORT = PHASE6 / "app" / "reports" / "pcal-lp-ciclos-corrigidos-001-a-005-import-report.json"
ORIGEM = "pcal-lp-ciclos-corrigidos-001-a-005"
...
def main(do_import=False):
    ...
    for q in incoming:
        ...
        mapped = SUBTOPIC_MAP.get(q.get("subtopicoId") or "") or TOPIC_MAP.get(q.get("topicoId") or "")
        ...
        if t not in ("certo_errado", "true_false", "ce"):
        ...
        item = {
            ...
            "ano": None,
            "fonteProva": fonte.get("referencia") or fonte.get("arquivo") or "Ciclos corrigidos 001–005 PC-AL",
            "tipo": "certo_errado",
            "enunciado": stmt,
            ...
            "subtopic_id": mapped,
            "fonte": f"Ciclos corrigidos 001–005 · {fonte.get('arquivo') or 'edital'}".strip(" ·"),
    ...
    OUT_READY.write_text(json.dumps({
        "schemaVersion": 1,
        "name": "pcal-lp-ciclos-corrigidos-001-a-005-ready",
    ...
    print("=== PRE-IMPORT CICLOS CORRIGIDOS 001–005 ===")
    print(json.dumps({
